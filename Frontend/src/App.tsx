                        ...
                        <For each={tweetList()?.items}>
                                        ...
                                        <Show
                                            ...
                                            fallback={
                                                <>
                                                    ...
                                                    {tweet.image_path&&(
                                                        <img src={mockBackend.getImage(tweet.id)} 
                                                    alt={tweet.topic} title={tweet.topic}  
                                                    class=" max-h-96 align-middle rounded-xl shadow-md mb-4 transition-transform duration-300 hover:scale-105"  />
                                                    )}
                            ...
                            <button onClick={() =>{ 
                                                ...
                                                <button
                                                    ...
                                                    class="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-red-500/30"
                                                >
